...
\code{error\_robustness} implementation replaces it with an invertible MA(3), the order
implied by this overlap. Its full production sweep is deliberately not folded into the
...
conclusion survives replacing the i.i.d. inflation disturbance with the invertible MA(3)
implied by overlapping four-quarter inflation. The companion implementation has
