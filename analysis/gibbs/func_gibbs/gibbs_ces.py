...
try:
    ...
    from analysis.gibbs.func_gibbs.gibbs_utils import assert_all_pos, getd, mvnrnd, sample_invgamma
...
def func_nkpc_ces(
    ...
    *,
    ...
    return {
        ...
        "opts": opts,
        "deprecated": (
            "analysis.gibbs.func_gibbs.gibbs_ces is legacy. "
            "Use analysis.gibbs.func_gibbs.ces.model or nkpc_hsa.inference.wrappers instead."
        ),
    }
