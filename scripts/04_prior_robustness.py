...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=[],
        help=(
            "Force coefficients nonnegative. Repeat or comma-separate, e.g. --positive kappa_0,delta. "
    ...
    for data_spec_name, data_spec in data_specs.items():
        spec_tables = []
        for model in models:
            print(f"Prior robustness {model} [{data_spec_name}]...")
            ...
            model_table = prior_robustness_table(idata_map)
