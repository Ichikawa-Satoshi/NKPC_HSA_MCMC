...
written outside ``results/runs`` so they cannot enter the report run-set.
    ...
    python production/main_scripts/prior_decomposition_rho_delta.py [--spec unemployment_gap_core] [--quick]
"""
...
def write_decomposition_macros(*, model: str = "hsa_steady") -> Path | None:
    ...
    lines = ["% Generated by production/main_scripts/prior_decomposition_rho_delta.py; do not edit by hand."]
    found = False
