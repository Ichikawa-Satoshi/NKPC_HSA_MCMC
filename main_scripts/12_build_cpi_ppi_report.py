...
def assert_expected_sampler(runs, *, model: str, expected: str, label: str) -> None:
    ...
    if offenders:
        raise SystemExit(
            ...
            f"({', '.join(offenders[:6])}). Re-run production/main_scripts/rerun_hsa_full_particle_gibbs.py."
        )
...
def build_ces_hsa_bias_table(runs, *, command_prefix: str = "") -> pd.DataFrame:
    ...
    rows: list[dict[str, object]] = []
    direct_macros: list[str] = ["% Generated by production/main_scripts/12_build_cpi_ppi_report.py; do not edit by hand."]
...
def write_result_macros(
    ...
    *,
    ...
    lines = [
        "% Generated by production/main_scripts/12_build_cpi_ppi_report.py; do not edit by hand.",
...
def write_cross_design_macros(*run_sets, filename: str = "cross_design_macros.tex") -> Path:
    ...
    lines = ["% Generated by production/main_scripts/12_build_cpi_ppi_report.py; do not edit by hand."]
...
def main() -> None:
    ...
    subprocess.run(["python", str(ROOT / "production" / "main_scripts" / "make_spec_tables.py")], cwd=ROOT, check=True)
    subprocess.run(["python", str(ROOT / "production" / "main_scripts" / "11_additional_report_evidence.py")], cwd=ROOT, check=True)
