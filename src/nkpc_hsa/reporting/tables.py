...
PARAMETER_UNITS = {
    ...
    "kappa_N_empirical": "change in kappa_t per +10 log-point Nbar deviation",
    "d_kappa_d_logN": "change in kappa per one-unit log N",
    "zeta0": "fixed-reference price elasticity",
    "mu0": "fixed-reference flexible-price markup",
