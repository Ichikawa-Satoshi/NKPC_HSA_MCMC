...
priors.mu_alpha=0.7; priors.sigma_alpha=100;
priors.mu_kappa=0;   priors.sigma_kappa=100;
priors.mu_theta=0;   priors.sigma_theta=100;
priors.mu_beta=0;    priors.sigma_beta=100;
...
nkpc_hsa_decomp_outputgap_tv = func_nkpc_hsa_tv_xerror(pi, pi_prev, Epi, x, Nbar, Nhat, burn_in, sample, priors, opts);
x = data.unemp_gap;
nkpc_hsa_decomp_unemp_gap_tv = func_nkpc_hsa_tv_xerror(pi, pi_prev, Epi, x, Nbar, Nhat, burn_in, sample, priors, opts);
disp("Done!!!!!!!")
%%
