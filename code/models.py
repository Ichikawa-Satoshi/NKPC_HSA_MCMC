...
def model_0_0(pi, pi_expect, Y):
    ...
    kappa = numpyro.sample("kappa", numpyro.distributions.HalfNormal(1))
    # state space model
...
def model_1(pi, pi_expect, Y, l):
    ...
    beta = numpyro.sample("beta", numpyro.distributions.Normal(1, 1))
    kappa = numpyro.sample("kappa", numpyro.distributions.HalfNormal(1))
    rho = numpyro.sample("rho", numpyro.distributions.HalfNormal(1))
    theta = numpyro.sample("theta", numpyro.distributions.HalfNormal(1))
    # state space model
...
def model_3(pi, pi_expect, Y, Y_prev, l):
    ...
    rho2 = numpyro.sample("rho2", numpyro.distributions.HalfNormal(1))
...
def model_5(pi, pi_prev, pi_expect, Y, Y_prev, l):
    ...
    rho3 = numpyro.sample("rho3", numpyro.distributions.HalfNormal(1))
